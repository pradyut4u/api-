...
export default class BookRequest extends React.Component{
	...
	//		alert("get book API flatlist"+this.state.showFlatList)
            var books = await BookSearch.searchbook("harry","AIzaSyDs5qH61LrIlsfhtdq7aTLfcegv2FZ2h3Y")
            this.setState({
	...
	render(){
		...
		return(
			...
			<TextInput style={{marginTop:50}} placeholder="Book name" onChangeText={text=>this.getBookApi(text)} onClear={text=>this.getBookApi("")} value={this.state.bookName}/>
